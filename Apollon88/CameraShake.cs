...
public class CameraShake : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        shake = this; //This keyword is class specific, it relates to the class it is being referenced from
    }
    ...
    IEnumerator Shake()
    {
        ...
        while (shakeDuration > 0.01f)
        {
            ...
            shakeDuration -= Time.deltaTime;//= Mathf.Lerp(shakeDuration, 0, Time.deltaTime);//Lerp the time, so it is less and tapers off towards the end.
